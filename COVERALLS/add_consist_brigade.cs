...
namespace COVERALLS
{
    public partial class add_consist_brigade : Form
    {
        ...
        private void add_consist_brigade_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            brigades_add.dataGridView2.Rows.Add(dataGridView1.CurrentRow.Cells[0].Value, dataGridView1.CurrentRow.Cells[1].Value, dataGridView1.CurrentRow.Cells[2].Value, dataGridView1.CurrentRow.Cells[3].Value, dataGridView1.CurrentRow.Cells[4].Value);
            this.Close();
        }
    }
}
